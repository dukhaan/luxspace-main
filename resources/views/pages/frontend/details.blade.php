      ...
      <div class="flex flex-wrap my-4 md:my-12">
        ...
        <div class="flex-1 px-4 md:p-6">
          ...
          <form action="{{ route('cart-add', $product->id) }}" method="POST">
            @csrf
            <button
              class="transition-all duration-200 bg-blue-200 text-black focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex"
              ><svg
      ...
      <div class="container mx-auto">
        <div class="flex flex-start mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Complete your journey <br class="" />with what we recommend
          </h3>
        </div>
