    ...
    <section class="flex items-center hero">
      ...
      >
        <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
          The Only Things <br class="" />You've Need
        </h1>
        <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
          Kami menyediakan semua barang berkelas yang
          <br class="hidden lg:block" />membuat kebutuhan anda terpenuhi
        </h2>
        <div>
          <a
            href="#browse-the-room"
            class="bg-blue-200 text-black hover:bg-blue hover:text-white-200 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200"
            >Explore Now</a
          >
        </div>
      </div>
            ...
            <button
              ...
              <div class="absolute w-full h-full">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/6mecS35YDpg?si=QbJ8Dyg48JKW9f-w"
                  frameborder="0"
      ...
      <div class="container mx-auto">
        <div class="flex flex-start mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Jelajahi Beragam <br class="" />Barang yang Kami Berikan
          </h3>
        </div>
        <div class="grid grid-rows-2 grid-cols-9 gap-4">
          ...
          >
            ...
            <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
              <h5 class="text-lg font-semibold">ㅤㅤㅤㅤBackpack</h5>
              <span class="">ㅤㅤㅤㅤ18.309 items</span>
            </div>
          ...
          >
            ...
            >
              <h5 class="text-lg text-white font-semibold">Cook</h5>
          ...
          >
            ...
            <div
              class="overlay right-0 left-0 top-0 bottom-0 md:bottom-auto flex justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12"
            >
              <h5 class="text-lg font-semibold">Books</h5>
          ...
          <div class="relative col-span-9 row-span-1 md:col-span-4 card">
            ...
            <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72 pb-8">
              <h5 class="text-lg font-semibold">Gaming</h5>
              <span class="">8.372 items</span>
            </div>
            <a href="{{ route('details', 'slug') }}" class="stretched-link">
              <!-- fake children -->
            </a>
    ...
    <section class="flex flex-col py-16">
      <div class="container mx-auto mb-4">
        <div class="flex justify-center text-center mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Just Arrived <br class="" />Exclusive for you
          </h3>
        </div>
      </div>
